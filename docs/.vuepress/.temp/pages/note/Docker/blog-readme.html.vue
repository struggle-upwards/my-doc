<template><div><h1 id="blog启动服务" tabindex="-1"><a class="header-anchor" href="#blog启动服务"><span>blog启动服务</span></a></h1>
<h3 id="使用docker分开管理服务" tabindex="-1"><a class="header-anchor" href="#使用docker分开管理服务"><span>使用docker分开管理服务</span></a></h3>
<div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre v-pre class="language-bash"><code><span class="line"><span class="token builtin class-name">cd</span> web</span>
...
<div class="language-docker line-numbers-mode" data-ext="docker" data-title="docker"><pre v-pre class="language-docker"><code><span class="line">version: '3.8'</span>
<span class="line"></span>
