<template><div><h1 id="docker部署gin-vue博客" tabindex="-1"><a class="header-anchor" href="#docker部署gin-vue博客"><span>docker部署gin,vue博客</span></a></h1>
<h3 id="安装nginx" tabindex="-1"><a class="header-anchor" href="#安装nginx"><span>安装nginx</span></a></h3>
<div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre v-pre class="language-bash"><code><span class="line"><span class="token function">docker</span> pull nginx</span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h3 id="部署vue3" tabindex="-1"><a class="header-anchor" href="#部署vue3"><span>部署Vue3</span></a></h3>
<p><strong>打包vue3项目</strong></p>
<div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre v-pre class="language-bash"><code><span class="line"><span class="token function">npm</span> run build</span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p><strong>nginx配置(default)</strong></p>
<div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre v-pre class="language-bash"><code><span class="line">server <span class="token punctuation">{</span></span>
...
<div class="language-docker line-numbers-mode" data-ext="docker" data-title="docker"><pre v-pre class="language-docker"><code><span class="line"><span class="token comment"># 设置基础镜像</span></span>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="部署gin" tabindex="-1"><a class="header-anchor" href="#部署gin"><span>部署gin</span></a></h3>
<p><strong>编写dockerfile</strong></p>
<div class="language-docker line-numbers-mode" data-ext="docker" data-title="docker"><pre v-pre class="language-docker"><code><span class="line"><span class="token comment">#源镜像</span></span>
