<template><div><h3 id="区别一-设计思想" tabindex="-1"><a class="header-anchor" href="#区别一-设计思想"><span>区别一：设计思想</span></a></h3>
<blockquote>
<p>props的设计思想是传递状态，将数据驱动组件的思想贯彻到底，子组件的渲染取决于父组件传递的数据；
slot的设计思想是传递DOM节点，将父组件的模板代码节点直接传递给子组件的某个slot，来达到最终渲染的目的；</p>
</blockquote>
<h3 id="区别二-作用范围" tabindex="-1"><a class="header-anchor" href="#区别二-作用范围"><span>区别二：作用范围</span></a></h3>
<blockquote>
