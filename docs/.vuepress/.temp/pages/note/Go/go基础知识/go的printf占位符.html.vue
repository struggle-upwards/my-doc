<template><div><h1 id="go的printf占位符" tabindex="-1"><a class="header-anchor" href="#go的printf占位符"><span>go的printf占位符</span></a></h1>
<div class="language-go line-numbers-mode" data-ext="go" data-title="go"><pre v-pre class="language-go"><code><span class="line"><span class="token operator">%</span>v    值的默认格式。</span>
