import{_ as n,c as s,o as a,a as e}from"./app-DjAegRR8.js";const i={},l=e(`<h1 id="docker部署gin-vue博客" tabindex="-1"><a class="header-anchor" href="#docker部署gin-vue博客"><span>docker部署gin,vue博客</span></a></h1><h3 id="安装nginx" tabindex="-1"><a class="header-anchor" href="#安装nginx"><span>安装nginx</span></a></h3><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="line"><span class="token function">docker</span> pull nginx</span>
