import{_ as s,c as a,o as n,a as e}from"./app-DjAegRR8.js";const l={},i=e(`<h1 id="gin实现热加载" tabindex="-1"><a class="header-anchor" href="#gin实现热加载"><span>gin实现热加载</span></a></h1><h3 id="一、热加载是什么" tabindex="-1"><a class="header-anchor" href="#一、热加载是什么"><span>一、热加载是什么</span></a></h3><p>热加载：当我们对代码进行修改时，程序能够自动重新加载并执行，这在我们开发中是非常便利的，可以快速进行代码测试，省去了每次手动重新编译。</p><h3 id="二、使用air进行热加载" tabindex="-1"><a class="header-anchor" href="#二、使用air进行热加载"><span>二、使用Air进行热加载</span></a></h3><p><em><code>地址：https://github.com/cosmtrek/air</code></em></p><p>具有以下特性：</p><ul><li>彩色日志输出</li><li>自定义构建或二进制命令</li><li>支持忽略子目录</li><li>启动后支持监听新目录</li><li>更好的构建过程</li></ul><h4 id="安装" tabindex="-1"><a class="header-anchor" href="#安装"><span>安装</span></a></h4><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="line">go get <span class="token parameter variable">-u</span> github.com/cosmtrek/air</span>
